...
The written report is under the name "report.md" in the main branch of this repository. 
...
Write a Credit Risk Analysis Report Write a brief report that includes a summary and analysis of the performance of the machine learning models that you used in this homework. 
...
All code used in this assignment was created using resources from class, collaborating with classmates, and other online resources. 
